...
<template>
    <div class="navbar bg-base-100 px-4">
        <div class="navbar-start w-1/3">
            <button class="btn btn-ghost btn-circle min-h-0 h-10 w-10 me-3">
                <span class="material-symbols-rounded">
                    menu
                </span>
            </button>
            <div>
                <svg xmlns="http://www.w3.org/2000/svg" id="yt-ringo2-svg_yt14" width="93" height="20"
        ...
        <div class="navbar-center w-1/3">
            <form class="flex w-full border border-neutral-200 ps-6 rounded-full">
                <input type="text" placeholder="Search" v-model="searchKeyword"
                    class="input input-ghost flex-1 p-0 rounded-none outline-none border-none focus:outline-none focus:border-none" />
                <button type="submit"
                    class="btn rounded-s-none rounded-e-full border-s-neutral-200 w-20 hover:bg-neutral-200 hover:border-none"
                    @click.prevent="console.log(searchKeyword)">
                    <span class="material-symbols-rounded">
                        search
                    </span>
                </button>
